...
**Fixed (mechanical):**
- Bullet list by file, e.g., `` `docs/ram/requirements/business-rules.md`: stripped 11 heading number prefixes, removed stale TOC, normalized 3 smart quotes ``.
