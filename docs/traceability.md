...
> **Platform-core rows (`UC-RUB-*`, `UC-SEC-*`, `UC-TEA-*`, `UC-STU-*`, `UC-INS-*`, `UC-ACC-*`, `UC-WAR-*`, `UC-EVA-*`).** These are the established, in-production course-management, weekly-activity-report, and peer-evaluation features, so their status is `✅ Implemented`. Their concrete spec→code mapping (the Frontend / Backend / Tests cells, under `backend/src/main/java/team/projectpulse/{course,section,team,student,instructor,activity,evaluation,rubric}` and `frontend/src/`) is shown as `TODO`; it was not mapped in this pass and will be filled in the deferred doctype-first follow-up.

| UC | Use Case | Status | FR IDs | Frontend | Backend | Tests |
|----|----------|--------|--------|----------|---------|-------|
| UC-RUB-1 | The Course Admin creates a rubric | ✅ Implemented | — | TODO | TODO | TODO |
| UC-SEC-1 | The Course Admin finds course sections | ✅ Implemented | — | TODO | TODO | TODO |
| UC-SEC-2 | The Course Admin views a course section | ✅ Implemented | — | TODO | TODO | TODO |
| UC-SEC-3 | The Course Admin creates a course section | ✅ Implemented | — | TODO | TODO | TODO |
| UC-SEC-4 | The Course Admin edits a course section | ✅ Implemented | — | TODO | TODO | TODO |
| UC-SEC-5 | The Course Admin sets up active weeks for a course section | ✅ Implemented | — | TODO | TODO | TODO |
| UC-TEA-1 | The Course Admin/Instructor finds teams | ✅ Implemented | — | TODO | TODO | TODO |
| UC-TEA-2 | The Course Admin/Instructor views a team | ✅ Implemented | — | TODO | TODO | TODO |
| UC-TEA-3 | The Course Admin creates a team | ✅ Implemented | — | TODO | TODO | TODO |
| UC-TEA-4 | The Course Admin edits a team | ✅ Implemented | — | TODO | TODO | TODO |
| UC-TEA-5 | The Course Admin assigns students to teams | ✅ Implemented | — | TODO | TODO | TODO |
| UC-TEA-6 | The Course Admin removes a student from a team | ✅ Implemented | — | TODO | TODO | TODO |
| UC-TEA-7 | The Course Admin deletes a team | ✅ Implemented | — | TODO | TODO | TODO |
| UC-STU-1 | The Course Admin invites students to join a course section | ✅ Implemented | — | TODO | TODO | TODO |
| UC-STU-2 | The Course Admin/Instructor finds students | ✅ Implemented | — | TODO | TODO | TODO |
| UC-STU-3 | The Course Admin/Instructor views a student | ✅ Implemented | — | TODO | TODO | TODO |
| UC-STU-4 | The Course Admin deletes a student | ✅ Implemented | — | TODO | TODO | TODO |
| UC-INS-1 | The Course Admin invites instructors to register an account | ✅ Implemented | — | TODO | TODO | TODO |
| UC-INS-2 | The Course Admin assigns instructors to teams | ✅ Implemented | — | TODO | TODO | TODO |
| UC-INS-3 | The Course Admin removes an instructor from a team | ✅ Implemented | — | TODO | TODO | TODO |
| UC-INS-4 | The Course Admin finds instructors | ✅ Implemented | — | TODO | TODO | TODO |
| UC-INS-5 | The Course Admin views an instructor | ✅ Implemented | — | TODO | TODO | TODO |
| UC-INS-6 | The Course Admin deactivate an instructor | ✅ Implemented | — | TODO | TODO | TODO |
| UC-INS-7 | The Course Admin reactivate an instructor | ✅ Implemented | — | TODO | TODO | TODO |
| UC-ACC-1 | The Student sets up a student account | ✅ Implemented | — | TODO | TODO | TODO |
| UC-ACC-2 | The Student edits an account | ✅ Implemented | — | TODO | TODO | TODO |
| UC-ACC-3 | The Instructor sets up an instructor account | ✅ Implemented | — | TODO | TODO | TODO |
| UC-WAR-1 | The Student manages activities in a Weekly Activity Report (WAR) | ✅ Implemented | — | TODO | TODO | TODO |
| UC-WAR-2 | The Instructor/Student generates a WAR report of a team | ✅ Implemented | — | TODO | TODO | TODO |
| UC-WAR-3 | The Instructor generates a WAR report of the student | ✅ Implemented | — | TODO | TODO | TODO |
| UC-EVA-1 | The Student submits a peer evaluation for the previous week | ✅ Implemented | — | TODO | TODO | TODO |
| UC-EVA-2 | The Student views her own peer evaluation report | ✅ Implemented | — | TODO | TODO | TODO |
| UC-EVA-3 | The Instructor generates a peer evaluation report of the entire course section | ✅ Implemented | — | TODO | TODO | TODO |
| UC-EVA-4 | The Instructor generates a peer evaluation report of a student | ✅ Implemented | — | TODO | TODO | TODO |
